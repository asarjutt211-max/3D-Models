/* ================================================================
   WARP STARFIELD — optimized for PC + mobile
================================================================ */
(function () {
  ...
  // ============================================
  const STAR_COUNT = isTouch ? 700 : 1400;
  const MAX_Z = 1400;
  ...
  // ============================================
  // INPUT — unified pointer events (works everywhere)
  // ============================================
  const pointer = { x: 0, y: 0, tx: 0, ty: 0 };
  let warpBoost = 0;

  // Steering — pointermove works for both mouse and touch
  window.addEventListener('pointermove', e => {
    pointer.tx = (e.clientX / W - 0.5) * 2;
    pointer.ty = (e.clientY / H - 0.5) * 2;
  }, { passive: true });

  // Warp burst — pointerdown works for click and tap
